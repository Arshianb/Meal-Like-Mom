...
/**
 * Annotation class that can only be used on {@link AppCompatActivity} or {@link Fragment}, a
...
public @interface Puppet {
    ...
    /**
     * Allow or not exit the host {@link AppCompatActivity}/{@link android.support.v4.app.Fragment} as the
     * stack size = 1 .
     * <p>
