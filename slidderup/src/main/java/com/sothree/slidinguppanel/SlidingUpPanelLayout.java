...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Sets whether or not the panel overlays the app_logo
     *
     * @param overlayed
     */
    ...
    /**
     * Sets whether or not the main app_logo is clipped to the top of the panel
     *
     * @param clip
     */
    ...
    /**
     * Check whether or not the main app_logo is clipped to the top of the panel
     */
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mSlideableView != null && mSlideableView != child) { // if main view
            ...
            // Unless the panel is set to overlay app_logo
